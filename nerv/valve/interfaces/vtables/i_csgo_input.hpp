...
public:
    ...
    c_user_cmd* get_user_cmd(void* local_controller)
    {
        ...
        static auto construct_input_data = reinterpret_cast<void* (__fastcall*)(void*, int)>(g_opcodes->scan_absolute(g_modules->m_modules.client_dll.get_name(), "E8 ? ? ? ? 41 83 3F FF 48 8B C8 48 89 44 24 60", 0x1));
        static auto sig_poo = *reinterpret_cast<void**>(g_opcodes->scan_absolute(g_modules->m_modules.client_dll.get_name(), "48 8B 0D ? ? ? ? E8 ? ? ? ? 41 83 3F FF", 0x3));
        ...
        static auto automake_user_cmd = reinterpret_cast<void*>(g_opcodes->scan_absolute(g_modules->m_modules.client_dll.get_name(), "E8 ? ? ? ? 48 89 44 24 40 48 8D 4D F0", 0x1));
